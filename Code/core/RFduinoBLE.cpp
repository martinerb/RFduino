...
RFduinoBLEClass::RFduinoBLEClass() {
	...
	uint8_t uuid[16] = { 0xE2, 0xC5, 0x6D, 0xB5, 0xDF, 0xFB, 0x48, 0xD2, 0xB0,
			0x60, 0xD0, 0xF5, 0xA7, 0x10, 0x96, 0xE0 };
...
void RFduinoBLEClass::updateConnInterval(int min_conn_interval_ms,
		int max_conn_interval_ms) {
